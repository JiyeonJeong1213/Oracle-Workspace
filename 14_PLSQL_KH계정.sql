...
-- 1_2) 레퍼런스 타입 변수 선언 및 초기화(어떤 테이블의 어떤 컬럼의 데이터타입을 참조해서 그 타입으로 지정하겠다)
...
BEGIN
    ...
    -- 사원의 사번이 200번인 각 사원의 사번, 사원명, 급여를 대입
...
/*
    ...
    각 자료형 EMPLOYEE(EMP_ID, EMP_NAME, JOB_CODE, SALARY) DEPARTMENT(DEPT_TITLE)을
    참조하도록
...
-- NCODE값이 KO일 경우 TEAM에 한국팀 대입, 그게 아닐 경우 해외팀 대입
-- 사번, 이름, 부서, 소속(TEAM) 출력
DECLARE 
    EID EMPLOYEE.EMP_ID%TYPE;
    ENAME EMPLOYEE.EMP_NAME%TYPE;
...
EXCEPTION
    --WHEN ZERO_DIVIDE THEN DBMS_OUTPUT.OUT_LINE('0으로 나눌 수 없습니다');
